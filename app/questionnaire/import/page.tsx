    ...
    try {
      ...
      Object.entries(row).forEach(([key, value]) => {
        ...
        try {
          ...
          if (response.ok) {
            const data = await response.json() as { client: any, responseSet: any }
            importResults.push({
              email,
              name: data.client.name,
              isNew: data.client.isNew,
              responsesCount: data.responseSet.responsesCount,
              version: data.responseSet.version
            })
          } else {
          ...
          <div className="mt-8 bg-white rounded-lg shadow border border-ponte-sand p-6">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2">
                {validationResults.clientAnalysis.map((client: any, index: number) => (
            ...
            {validationResults.comparison.missingInCsv.length > 0 && (
              <div className="mb-6">
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {validationResults.comparison.missingInCsv.map((item: any, index: number) => (
            ...
            {validationResults.comparison.partialMatches.length > 0 && (
              <div className="mb-6">
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  {validationResults.comparison.partialMatches.map((item: any, index: number) => {
